...
*****************************************************************************************/
VOID GFXHIDD__Hidd_Gfx__NominalDimensions(OOP_Class *cl, OOP_Object *o, struct pHidd_Gfx_NominalDimensions *msg)
{
...
*****************************************************************************************/
OOP_Object *GFXHIDD__Hidd_Gfx__CreateObject(OOP_Class *cl, OOP_Object *o, struct pHidd_Gfx_CreateObject *msg)
{
    struct Library *OOPBase = CSD(cl)->cs_OOPBase;
    struct HiddGfxData *data = OOP_INST_DATA(cl, o);
        ...
        if (IS_GFX_ATTR(tag->ti_Tag, idx))
        {
            switch (idx)
            {
                case aoHidd_Gfx_PixFmtTags:
                    ...
                    mdb->pixfmts[pfidx] = GFXHIDD__Hidd_Gfx__RegisterPixFmt(cl, def_pixfmt_tags);
...
HIDDT_ModeID *GFXHIDD__Hidd_Gfx__QueryModeIDs(OOP_Class *cl, OOP_Object *o,
...
VOID GFXHIDD__Hidd_Gfx__ReleaseModeIDs(OOP_Class *cl, OOP_Object *o,
...
HIDDT_ModeID GFXHIDD__Hidd_Gfx__NextModeID(OOP_Class *cl, OOP_Object *o,
...
BOOL GFXHIDD__Hidd_Gfx__GetMode(OOP_Class *cl, OOP_Object *o, struct pHidd_Gfx_GetMode *msg)
{
    ULONG                   pfidx, syncidx;
    struct HiddGfxData *data;
    struct mode_db          *mdb;
...
BOOL GFXHIDD__Hidd_Gfx__SetMode(OOP_Class *cl, OOP_Object *o, struct pHidd_Gfx_SetMode *msg)
{
    return FALSE;
}
...
OOP_Object *GFXHIDD__Hidd_Gfx__Show(OOP_Class *cl, OOP_Object *o, struct pHidd_Gfx_Show *msg)
{
    struct Library *OOPBase = CSD(cl)->cs_OOPBase;
    struct HiddGfxData *data = OOP_INST_DATA(cl, o);
...
ULONG GFXHIDD__Hidd_Gfx__ShowViewPorts(OOP_Class *cl, OOP_Object *o, struct pHidd_Gfx_ShowViewPorts *msg)
{
...
BOOL GFXHIDD__Hidd_Gfx__SetCursorShape(OOP_Class *cl, OOP_Object *o,
...
VOID GFXHIDD__Hidd_Gfx__ShowImminentReset(OOP_Class *cl, OOP_Object *obj, OOP_Msg msg)
{
}
...
BOOL GFXHIDD__Hidd_Gfx__CheckMode(OOP_Class *cl, OOP_Object *o, struct pHidd_Gfx_CheckMode *msg)
{
...
OOP_Object *GFXHIDD__Hidd_Gfx__GetPixFmt(OOP_Class *cl, OOP_Object *o, struct pHidd_Gfx_GetPixFmt *msg)
{
    OOP_Object *fmt;
...
OOP_Object *GFXHIDD__Hidd_Gfx__GetSync(OOP_Class *cl, OOP_Object *o, struct pHidd_Gfx_GetSync *msg)
{
    struct HiddGfxData *data = OOP_INST_DATA(cl, o);
...
ULONG GFXHIDD__Hidd_Gfx__ModeProperties(OOP_Class *cl, OOP_Object *o, struct pHidd_Gfx_ModeProperties *msg)
{
    struct Library *OOPBase = CSD(cl)->cs_OOPBase;
...
BOOL GFXHIDD__Hidd_Gfx__GetGamma(OOP_Class *cl, OOP_Object *o, struct pHidd_Gfx_Gamma *msg)
{
    return FALSE;
}
...
BOOL GFXHIDD__Hidd_Gfx__SetGamma(OOP_Class *cl, OOP_Object *o, struct pHidd_Gfx_Gamma *msg)
{
    return FALSE;
}
...
BOOL GFXHIDD__Hidd_Gfx__QueryHardware3D(OOP_Class *cl, OOP_Object *o, struct pHidd_Gfx_QueryHardware3D *msg)
{
    return FALSE;
}
...
BOOL GFXHIDD__Hidd_Gfx__GetMaxSpriteSize(OOP_Class *cl, OOP_Object *o, struct pHidd_Gfx_GetMaxSpriteSize *msg)
{
    IPTR types;
    struct Library *OOPBase = CSD(cl)->cs_OOPBase;
...
OOP_Object *GFXHIDD__Hidd_Gfx__NewOverlay(OOP_Class *cl, OOP_Object *o, struct pHidd_Gfx_NewOverlay *msg)
{
    struct Library *UtilityBase = CSD(cl)->cs_UtilityBase;
...
VOID GFXHIDD__Hidd_Gfx__DisposeOverlay(OOP_Class *cl, OOP_Object *o, struct pHidd_Gfx_DisposeOverlay *msg)
{
    struct Library *OOPBase = CSD(cl)->cs_OOPBase;
...
ULONG GFXHIDD__Hidd_Gfx__MakeViewPort(OOP_Class *cl, OOP_Object *o, struct pHidd_Gfx_MakeViewPort *msg)
{
...
void GFXHIDD__Hidd_Gfx__CleanViewPort(OOP_Class *cl, OOP_Object *o, struct pHidd_Gfx_CleanViewPort *msg)
{
...
ULONG GFXHIDD__Hidd_Gfx__PrepareViewPorts(OOP_Class *cl, OOP_Object *o, struct pHidd_Gfx_ShowViewPorts *msg)
{
    return MCOP_OK;
}
...
void GFXHIDD__Hidd_Gfx__UpdateBitMap(OOP_Class *cl, OOP_Object *o, OOP_Object *bm,
